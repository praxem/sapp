...
import { EmployeeAngularComponent } from 'app/entities/employee-angular/employee-angular.component';
...
describe('Component Tests', () => {
  describe('EmployeeAngular Management Component', () => {
    let comp: EmployeeAngularComponent;
    let fixture: ComponentFixture<EmployeeAngularComponent>;
    let service: EmployeeAngularService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [SappTestModule],
        declarations: [EmployeeAngularComponent],
        providers: [
          {
        ...
        .overrideTemplate(EmployeeAngularComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(EmployeeAngularComponent);
