...
import { JobAngularComponent } from 'app/entities/job-angular/job-angular.component';
...
describe('Component Tests', () => {
  describe('JobAngular Management Component', () => {
    let comp: JobAngularComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(JobAngularComponent, '')
        .compileComponents();
