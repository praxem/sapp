...
import { JobHistoryAngularComponent } from 'app/entities/job-history-angular/job-history-angular.component';
...
describe('Component Tests', () => {
  describe('JobHistoryAngular Management Component', () => {
    let comp: JobHistoryAngularComponent;
    let fixture: ComponentFixture<JobHistoryAngularComponent>;
    let service: JobHistoryAngularService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [SappTestModule],
        declarations: [JobHistoryAngularComponent],
        providers: [
          {
        ...
        .overrideTemplate(JobHistoryAngularComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(JobHistoryAngularComponent);
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new JobHistoryAngular(123)],
            headers
          })
        )
      );
